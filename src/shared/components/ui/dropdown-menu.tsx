...
import * as S from './dropdown-menu.style'
...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRight className={S.chevronRight()} />
  </DropdownMenuPrimitive.SubTrigger>
))
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    {...props}
  >
    <span className={S.itemIndicatorWrapper()}>
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem ref={ref} className={cn(S.radioItem(), className)} {...props}>
    <span className={S.itemIndicatorWrapper()}>
      <DropdownMenuPrimitive.ItemIndicator>
        <Circle className={S.circleIcon()} />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator ref={ref} className={cn(S.separator(), className)} {...props} />
))
