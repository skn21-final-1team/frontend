...
export const triggerButton = cva(
  'w-fit justify-start gap-1.5 px-2 py-1 h-auto text-xs font-semibold text-primary bg-card hover:bg-accent/50 border-border shadow-sm'
);
...
export const dropdownLabel = cva(
  'font-semibold text-sm py-1.5 flex justify-between items-center'
);
...
export const errorBox = cva(
  'rounded bg-destructive/10 p-1.5 text-xs text-destructive'
);
